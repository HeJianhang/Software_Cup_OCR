...
QT_MOC_LITERAL(1, 9, 19), // "customShowMinWindow"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 17) // "customCloseWindow"

    },
    "TitleBar\0customShowMinWindow\0\0"
    "customCloseWindow"
};
...
void TitleBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->customShowMinWindow(); break;
        case 1: _t->customCloseWindow(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TitleBar::customShowMinWindow)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (TitleBar::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TitleBar::customCloseWindow)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void TitleBar::customShowMinWindow()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void TitleBar::customCloseWindow()
{
